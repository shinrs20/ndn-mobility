...
SPEED="1.40 2.80 4.20 5.60 7.00 8.40 9.80 11.20"
...
do
    ...
    ./graphs/app-data-compare.R -r -d -f results/MobilityICC-app-delays-smart-con-$FNAME-01-001-004.txt -c results/MobilityICC-app-delays-3n-con-$FNAME-01-001-004.txt --str1="NDN Smart Flooding" --str2="3N + Smart Flooding" -t "Mobile Consumer" -s 20

    # Producer Mobility
    echo "Creating Producer mobility network delay $i"
    ./graphs/app-data-compare.R -r -d -f results/MobilityICC-app-delays-smart-prod-$FNAME-01-001-004.txt -c results/MobilityICC-app-delays-3n-prod-$FNAME-01-001-004.txt --str1="NDN Smart Flooding" --str2="3N + Smart Flooding" -t "Mobile Producer" -s 20
    ...
    ./graphs/app-data-j.R -r -s 20 -d -f results/MobilityICC-app-delays-3n-prod-$FNAME-01-001-004.txt -t "Application using 3N + Smart Flooding"
